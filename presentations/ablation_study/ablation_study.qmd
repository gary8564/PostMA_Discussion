...
Direct comparison with **task-supervised models** is not fully matched: they optimize on downstream labels, whereas MedSliM learns from unlabeled feature views. Large-scale DINO studies likewise generally claim *competitive transfer* rather than universal superiority over supervised models, which can remain stronger on task-matched endpoints.

- **Primary SSL comparator:** [3DINO](https://arxiv.org/abs/2501.11755), with emphasis on comparable accuracy at lower pretraining / inference compute
- **Additional SSL comparator:** [VoCo](https://arxiv.org/abs/2507.08254), representing native-3D medical SSL
- Keep supervised models as **reference ceilings**, not the main fairness claim
:::
