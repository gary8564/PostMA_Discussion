...
Note: Curia use DINOv2 pretrained on 200M CT/MRI slice images and the original paper uses kneeMRI dataset to showcase the results but only use the cnetral three slices to classify the ACL tear severity.
...
## Potential Improvements for MedSliM
...
## Proposed MedSliM v2 Components
